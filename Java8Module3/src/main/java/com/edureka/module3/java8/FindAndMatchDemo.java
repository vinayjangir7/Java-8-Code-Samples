...
public class FindAndMatchDemo {
	...
	public static void findAnyMatch(List<Book> catalog) {
		...
		System.out.println(catalog.stream().anyMatch(b -> "inferno".equalsIgnoreCase(b.getTitle())));

	}	

	public static void findAllMatch(List<Book> catalog) {

		System.out.println(catalog.stream().allMatch(b -> "inferno".equalsIgnoreCase(b.getTitle())));
