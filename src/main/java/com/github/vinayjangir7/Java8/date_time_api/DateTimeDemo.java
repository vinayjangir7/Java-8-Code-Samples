package com.github.vinayjangir7.Java8.date_time_api;
...
public class DateTimeDemo {
    ...
    private static void useLocalDate() {
        ...
        LocalTime time = LocalTime.of(21, 45, 20); // 13:45:20
        int hour = time.getHour(); // 21
        int minute = time.getMinute(); // 45
        int second = time.getSecond(); // 20
        System.out.println(time);

        LocalDateTime dt1 = LocalDateTime.of(2015, Month.AUGUST, 18, 21, 45, 20); // 2014-03-18T13:45
