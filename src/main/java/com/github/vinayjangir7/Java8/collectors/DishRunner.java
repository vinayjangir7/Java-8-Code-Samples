...
import com.github.vinayjangir7.Java8.models.Dish;
...
public class DishRunner {
    public static void main(String[] args) {
        ...
        Map<Dish.DishType, List<Dish>> groupedDishesByActualType = getGroupedDishesByActualType(dishList);
    ...
    private static Map<Dish.DishType, List<Dish>> getGroupedDishesByActualType(List<Dish> dishes) {
        return dishes.stream()
